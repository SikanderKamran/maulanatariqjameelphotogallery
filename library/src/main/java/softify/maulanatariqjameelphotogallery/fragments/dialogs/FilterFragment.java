...
import softify.maulanatariqjameelphotogallery.adapters.FilterAdapter;
...
import softify.maulanatariqjameelphotogallery.items.Category;
...
public class FilterFragment extends DialogFragment implements View.OnClickListener {
    ...
    private static final String TAG = "softify.maulanatariqjameelphotogallery.dialog.filter";
